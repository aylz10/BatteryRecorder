...
fun ServerSection(
    ...
    SplicedColumnGroup(
        ...
        item {
            M3ESwitchWidget(
                text = stringResource(R.string.settings_notification_icon_compat_mode),
                checked = state.notificationIconCompatModeEnabled,
                onCheckedChange = actions.setNotificationIconCompatModeEnabled
            )
        }
